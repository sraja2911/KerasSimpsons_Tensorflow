...
print "Now downloading the testing set"
...
for cf in gc.listFolder(imageFolderUID):  ## cf = characterFolder
    ...
    GirderImageInfoDict[cf['name']] = { 'girderFolderID': cf['_id'],'numItems': len(trainingSetCharImages), 'imageItemData': trainingSetCharImages,
                                      'imageItemNames' : [x['name'] for x in trainingSetCharImages]
                                      }
    ## Check each image item for appropriate tags.. i.e. characterClass and largeItem
